...
$(function(){
    $("#doughnutChart").drawDoughnutChart([
      { title: "Illustrator",   value : 120,  color: "#C7E18F" },
      { title: "Photoshop",     value:  80,   color: "#80CCA2" },
      { title: "PremierPro",      value:  90,   color: "#80CFCB" },
      { title: "MAYA",        value : 50,   color: "#63B5BA" },
      { title: "HTML&CSS",        value : 30,   color: "#92EA9B" }
